...
const TAG_MAPS = {
  swi: {
    ...
    "18-react-teorie.md": { title: "Vývoj aplikací v React", tags: ["web", "react", "frontend", "javascript"], time: 12 },
  ...
  dat: {
    ...
    "12-souborovy-system.md": { title: "Souborový systém a streamy", tags: ["programování", "c-sharp", "kódování"], time: 12 },
    "13-paralelni-async.md": { title: "Paralelní a asynchronní programování", tags: ["programování", "c-sharp", "async"], time: 12 },
    ...
    "21-orm.md": { title: "ORM (Object-Relational Mapper)", tags: ["databáze", "sql", "c-sharp", "architektura"], time: 12 },
  },
  cjl: {
